...
from nanoiqqi.config.schema import DingTalkConfig
...
class NanoiqqiDingTalkHandler(CallbackHandler):
    """
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to nanoiqqi via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = NanoiqqiDingTalkHandler(self)
    ...
    async def _on_message(self, content: str, sender_id: str, sender_name: str) -> None:
        """Handle incoming message (called by NanoiqqiDingTalkHandler).
