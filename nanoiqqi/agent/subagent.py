...
if TYPE_CHECKING:
    from nanoiqqi.agent.activity_sink import ActivitySink
...
class SubagentManager:
    ...
    def __init__(
        ...
        from nanoiqqi.agent.activity_sink import NoOpActivitySink
    ...
    async def spawn(
        ...
        bg_task = asyncio.create_task(
            self._run_subagent(task_id, task, display_label, origin, complexity, domain)
        )
    ...
    async def _run_subagent(
        ...
        from nanoiqqi.agent.activity_events import SubagentEndEvent, SubagentStartEvent
        ...
        try:
            ...
            while iteration < max_iterations:
                ...
                response = await self.provider.chat(
                    ...
                    subagent_complexity=complexity,
                    subagent_domain=domain,
                )
