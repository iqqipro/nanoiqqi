...
from nanoiqqi.cli import commands
...
def mock_prompt_session():
    ...
    with patch("nanoiqqi.cli.commands._PROMPT_SESSION", mock_session), \
         patch("nanoiqqi.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("nanoiqqi.cli.commands.PromptSession") as MockSession, \
         patch("nanoiqqi.cli.commands.FileHistory") as MockHistory, \
